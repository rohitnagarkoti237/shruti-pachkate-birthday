...
const birthdayMessages = [
  { emoji: '💜', title: '3+ Years & Counting...', text: 'From colleagues to the closest of friends — who knew that one office could bring two people this close? Every moment with you has been a gift, Shruti.' },
  { emoji: '✨', title: 'Where It All Began', text: 'We started in the same company, shared the same workspace, and built something truly special. I am grateful that life brought us together.' },
  { emoji: '🥰', title: 'You Deserve the World', text: 'You make ordinary days brighter just by being around. Your energy, your smile, your kindness — the world needs more people like you, Shruti.' },
  { emoji: '🎂', title: 'A Birthday Wish', text: 'On your special day, I want you to know — you deserve every bit of happiness. May this year bring you everything your heart wishes for.' },
  { emoji: '💫', title: 'Always Here for You', text: 'No matter where life takes us, I will always be there for you. Through thick and thin — you can always count on me, Shruti.' },
  { emoji: '🌟', title: 'The Bond We Share', text: '3 years of memories, laughter, late-night conversations, and growing together. I would not trade a single moment. Here is to many more years!' },
  { emoji: '🎉', title: 'Celebrating You!', text: 'Today is all about YOU — the most amazing, thoughtful, and kind-hearted person I know. The world is lucky to have you. Happy Birthday!' },
  { emoji: '💐', title: 'From Desk Mates to Best Mates', text: 'Who would have thought that two people sitting in the same office would build such a beautiful friendship? I truly cherish what we have.' },
  { emoji: '🦋', title: 'Growing Together', text: 'From our first conversation to this very day — we have grown so much together. Every chapter with you has been better than the last.' },
  { emoji: '🌙', title: 'My Constant Support', text: 'Through every high and low, every laugh and tough moment, you have always been there. I truly care about you, Shruti. Happy Birthday!' },
  { emoji: '🫶', title: 'Forever Grateful', text: 'Grateful for every day knowing you are part of my life. You make everything better just by being you. Cheers to another amazing year!' },
  { emoji: '🎈', title: 'Here is to Us', text: 'Every photo here holds a memory. Every memory holds a feeling. And every feeling reminds me how much you mean to me, Shruti Pachkate. 💜' },
  { emoji: '🥂', title: 'A Toast to You', text: 'To the person who turned a regular office into the best memories of my life — may your birthday be as wonderful and special as you are.' },
  { emoji: '🌸', title: 'Your Smile Says It All', text: 'You bring warmth wherever you go. 3+ years and your smile still makes everyone around you happier. Never stop being you, Shruti.' },
  { emoji: '💌', title: 'A Promise', text: 'I promise to always be there — to make you laugh, to support you through everything, and to celebrate every single birthday with you.' },
  { emoji: '🎊', title: 'The Best Part', text: 'Life gave me many things, but knowing you has been the best part. Happy Birthday to someone who truly makes the world a better place. 💜' },
  { emoji: '⭐', title: 'You Shine Bright', text: 'Among all the people I have met, you stand out the most. Keep being the incredible person you are. The world is better because of you.' },
  { emoji: '🌷', title: 'A Special Bond', text: 'From sharing a workplace to sharing all of life\'s ups and downs — every moment has been worth it. You are truly one of a kind, Shruti.' },
  { emoji: '💝', title: 'More Than Words', text: 'No birthday message can fully capture what you mean to me. But I hope these photos and memories remind you of how special our journey has been.' },
  { emoji: '🎁', title: 'The Greatest Gift', text: 'Knowing you has been the greatest gift life has given me. On your birthday, I just want to say — thank you for being YOU, Shruti Pachkate. 🎂' },
];
  ...
  <section class="section" style="padding-bottom: 40px;">
    <div class="message-card" style="margin: 0; padding: 64px 40px; background: linear-gradient(135deg, rgba(168,85,247,0.12), rgba(126,34,206,0.08)); border: 1px solid rgba(168,85,247,0.3);">
      ...
      <p style="font-size: 18px; line-height: 2; max-width: 700px;">
        ...
        आपली मैत्री तीन वर्षांहून अधिक जुनी आहे —<br>
        एकत्र काम केलं, एकत्र हसलो, खूप मजा केली.<br>
        तू एक अशी व्यक्ती आहेस जी सगळ्यांना आनंदी ठेवते.<br><br>
        तुझं हसणं सगळ्यांना खूश करतं.<br>
        तुझा स्वभाव खूपच चांगला आहे.<br>
        तुझ्यासारखी मैत्रीण मिळणं खूप भाग्याचं आहे.<br><br>
        या वाढदिवशी तुला खूप सारा आनंद मिळो,<br>
        तुझं प्रत्येक स्वप्न पूर्ण होवो,<br>
        आणि तू नेहमी अशीच हसत राहा. 🌟<br><br>
        <strong style="color: #e9d5ff;">वाढदिवसाच्या खूप खूप शुभेच्छा, श्रुती! 🎉</strong>
      </p>
    </div>
  </section>
